...
function AdminPanelUsers() {
  ...
  const getAllUsers = async (page , sortType , filterType , searchField , searchPhrase) => {
    ...
    try{
      ...
      if(loggedInUser){
        await fetch(`http://localhost:4001/users/get-all?page=${page}&sortType=${sortType}&filterType=${filterType}&searchField=${searchField}&searchPhrase=${searchPhrase}`, {
          method: "POST",
          headers: {
  ...
  const editModalAcceptHandler = async (e) => {
    ...
    fetch(`http://localhost:4001/users/${selectedUser._id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${loggedInUser.token}`,
  ...
  const changeUserRoleModalAcceptHandler = async (e) => {
    ...
    fetch(`http://localhost:4001/users/change-role/${selectedUser._id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${loggedInUser.token}`,
  ...
  const ChangeUserPasswordModalAcceptHandler = async (e) => {
    ...
    fetch(`http://localhost:4001/users/change-password/${selectedUser._id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${loggedInUser.token}`,
  ...
  const banUser = ({_id , name}) => {
    ...
    swal({
      ...
      if (result) {
        fetch(`http://localhost:4001/users/ban/${_id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${loggedInUser.token}`,
  ...
  const unbanUser = ({_id , name}) => {
    ...
    swal({
      ...
      if (result) {
        fetch(`http://localhost:4001/users/unban/${_id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${loggedInUser.token}`,
  ...
  const verifyUserEmail = ({_id , name}) => {
    ...
    swal({
      ...
      if (result) {
        fetch(`http://localhost:4001/users/verify-email/${_id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${loggedInUser.token}`,
  ...
  const unverifyUserEmail = ({_id , name}) => {
    ...
    swal({
      ...
      if (result) {
        fetch(`http://localhost:4001/users/unverify-email/${_id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${loggedInUser.token}`,
